...
<!-- 										  		</div> -->
												...
												<div class="form-group row">
												  ...
												  <div class="col-sm-9">
												    <input id="filiere_Nom_Ar" type="Date" class="form-control" name="dateRetrait"/>
												  </div>
												</div>
<!-- 										  		<div class="form-group row"> -->
<!-- 												  <label for="filiere_Nom_Ar" class="col-sm-3 control-label">Date de Retrait </label> -->
...
<!-- 												</div> -->
							...
							<!-- Début : Modal Add New Niveau -->
								      	...
								      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
								          	...
								          	<div class="modal-body">
								          		<div class="form-group row">
												    ...
												    <div class="col-sm-9">
												      <input id="niveau_code" type="text" class="form-control" name="code" placeholder="Code du document" required/>
												    </div>
										  		</div>
												<div class="form-group row">
												  <label for="niveau_Nom_Fr" class="col-sm-3 control-label">Nom du document</label>
												  <div class="col-sm-9">
												    <input id="niveau_Nom_Fr" type="text" class="form-control" name="nom_Fr" placeholder="Nom du document" required/>
												  </div>
												</div>
										  		<div class="form-group row">
							 ...
							 <!-- Début : Modal Update Niveau -->
								<div id="niveau_Update_Modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" data-backdrop="false">
									<div class="modal-dialog">
									<form id="niveau_Update_Form" method="POST" action="../TypeDocEtd/Update" >
								      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
								          	<div class="modal-header bg-info">
								        		<h4 class="modal-title text-white">
								        			Modifier le document
						...
						<!-- Content tab 4	: typedocperso-->
						<div id="content-tab-Pdocs" class="tab-pane" role="tabpanel" aria-labelledby="content-tab-Pdocs">
					   		<div class="alert bg-light text-secondary" role="alert">
					   			<i class="fa fa-cubes mr-2"></i>
					   			Type de Document Personnel
		        <a href="#" data-toggle="modal" data-target="#periode_Add_Modal" class="btn btn-outline-info float-right" title="Ajouter un Document"><i class="fa fa-plus"></i></a>
			...
			<!-- Début : Modal Add New Periode -->
				<div id="periode_Add_Modal" class="modal" tabindex="-1" role="dialog">
					<div class="modal-dialog">
					<form id="periode_Add_Form" method="POST" action="../TypeDocPrs/Add" >
				      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
				          	<div class="modal-header bg-info">
				        		<h4 class="modal-title text-white">
				        			Ajouter une periode
				          	...
				          	<div class="modal-body">
				          		<div class="form-group row">
						    		<label for="periode_code" class="col-sm-3 control-label">Code du document</label>
								    <div class="col-sm-9">
								      <input id="periode_code" type="text" class="form-control" name="code" placeholder="Code de document" required/>
								    </div>
						  		</div>
								<div class="form-group row">
								  <label for="periode_Nom_Fr" class="col-sm-3 control-label">Nom du document</label>
								  <div class="col-sm-9">
								    <input id="periode_Nom_Fr" type="text" class="form-control" name="nom_Fr" placeholder="Nom de document" required/>
								  </div>
								</div>
						  		<div class="form-group row">
			 ...
			 <!-- Début : Modal Update Periode -->
				<div id="periode_Update_Modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" data-backdrop="false">
					<div class="modal-dialog">
					<form id="periode_Update_Form" method="POST" action="../TypeDocPrs/Update" >
				      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
				          	<div class="modal-header bg-info">
				        		<h4 class="modal-title text-white">
				        			Modifier le période
				          	...
				          	<div class="modal-body">
				          		<div class="form-group row">
						    		<label for="periode_code" class="col-sm-3 control-label">Code</label>
								    <div class="col-sm-9">
								      <input  type="hidden" class="form-control" name="id" />
								...
								<div class="form-group row">
								  ...
								  <div class="col-sm-9">
								    <input id="periode_Nom_Fr" type="text" class="form-control" name="nom_Fr" placeholder="Nom de la période" required/>
								  </div>
								</div>
						  		<div class="form-group row">
								  <label for="periode_Nom_Ar" class="col-sm-3 control-label">إسم الفصل</label>
  			...
  			*****************************************************/
  			...
  			$('#data_table_niveaux').on('click','.niveau-details', function(evt){
  	  		...
  	  		/************** DataTable du Tab : Periodes **************/
  				...
  				/*  
  				/* On charger la liste des Periodes dans la TableData Periodes
  				*/
  	  			...
  	  			$('#data_table_periodes').on('click','.periode-details', function(evt){
  					...
  					$.ajax({
  						...
  						success: function(response,textStatus ,jqXHR){
  							...
  							var nom_FrItem ='<li class="list-group-item"><span><strong>Nom de la période  </strong></span><span class="float-right">'+response.nom_Fr+'</span></li>';

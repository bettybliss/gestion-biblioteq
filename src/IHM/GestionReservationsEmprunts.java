...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rendreButton.setForeground(new Color(255, 255, 0));
        emprunterButton = new javax.swing.JButton();
        emprunterButton.setForeground(new Color(255, 255, 0));
        affEmpButton = new javax.swing.JButton();
        affEmpButton.setForeground(new Color(255, 255, 0));
        affExempButton = new javax.swing.JButton();
        affExempButton.setForeground(new Color(255, 255, 0));
        ...
        empruntsButton.setBackground(new Color(255, 255, 0));
        ReservationButton = new javax.swing.JButton();
        ReservationButton.setBackground(new Color(255, 255, 0));
        ...
        auteurLabel1.setBackground(new Color(255, 255, 255));
        ...
        jScrollPane1.setBackground(new Color(128, 128, 128));
        ...
        menuEmpPanel.setBackground(new Color(128, 128, 128));
        menuEmpPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        rendreButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        emprunterButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        affEmpButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        affExempButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        jScrollPane2.setBackground(new Color(128, 128, 128));
        ...
        annulerResaButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        reserverButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        affResaButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        empruntsButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        ReservationButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        retourButton.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        ...
        titleResaEmpLabel.setForeground(new Color(255, 255, 0));
        titleResaEmpLabel.setText("Gestion des Réservations et Emprunts");

        jPanel3.setBackground(new Color(128, 128, 128));

        typeOeuvreLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        typeOeuvreLabel1.setForeground(new Color(255, 255, 255));
        typeOeuvreLabel1.setText("Type de l'oeuvre");

        identifiantLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        identifiantLabel1.setForeground(new Color(255, 255, 255));
        identifiantLabel1.setText("Identifiant ");

        auteurLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        auteurLabel1.setForeground(new Color(255, 255, 255));
        auteurLabel1.setText("Auteur");

        titreLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        titreLabel1.setForeground(new Color(255, 255, 255));
        titreLabel1.setText("Titre");

        categorieLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        categorieLabel1.setForeground(new Color(255, 255, 255));
        categorieLabel1.setText("Catégorie");

        nbExemplaire1.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        nbExemplaire1.setForeground(new Color(255, 255, 255));
        nbExemplaire1.setText("Nombre \nd'exemplaire");

        titreLabelValue.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        titreLabelValue.setText(" ");

        categorieLabelValue.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        categorieLabelValue.setText(" ");

        typeOeuvreLabelValue.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        typeOeuvreLabelValue.setText(" ");

        auteurLabelValue.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        auteurLabelValue.setText(" ");

        nbExemplaireLabelValue.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
        nbExemplaireLabelValue.setText(" ");

        identifiantComboBox.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // NOI18N
